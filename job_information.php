...
<html lang="en">
    <head>
        ...
        <div class="col-md-8">
            <h2>Informations of Job :</h2>
            <p><strong>Title of the job:</strong> <?php echo isset($_GET['jobTitle']) ? $_GET['jobTitle'] : ''; ?></p>
            <p><strong>Description of the job:</strong> <?php echo isset($_GET['jobDescription']) ? $_GET['jobDescription'] : ''; ?></p>
            <p><strong>Skills Required:</strong> <?php echo isset($_GET['skillsRequired']) ? $_GET['skillsRequired'] : ''; ?></p>
            <p><strong>Budget:</strong> <?php echo isset($_GET['budget']) ? $_GET['budget'] : ''; ?></p>
            <p><strong>Dadline:</strong> <?php echo isset($_GET['deadline']) ? $_GET['deadline'] : ''; ?></p>
